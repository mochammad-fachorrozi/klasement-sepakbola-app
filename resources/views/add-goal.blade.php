...
<body>
  ...
  <main>
    <section class="my-4">
      <div class="container">
        <h1 class="text-center">Form Input Hasil Pertandingan</h1>
          ...
          <table id="table" class="table">
            ...
            <tbody>
              <tr class="text-center border-bottom border-dark">
                <td>
                  <select class="form-select mb-2" name="inputs[0][klub1]">
                  ...
                  <input type="number" name="inputs[0][gol1]" placeholder="Masukan Score" class="form-control" required>
                </td>
                <td class="align-content-center">
                  <p>VS</p>
                </td>
                <td>
                  <select class="form-select mb-2" name="inputs[0][klub2]">
                    <option selected>Pilih Klub</option>
                    @foreach ($klubs as $klub)
                      <option value="{{ $klub->id }}">{{ $klub->nama_klub }}</option>
                    @endforeach
                  </select>
                  <input type="number" name="inputs[0][gol2]" placeholder="Masukan Score" class="form-control" required>
                </td>
                <td>
